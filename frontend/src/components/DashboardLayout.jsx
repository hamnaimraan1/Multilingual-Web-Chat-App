...
//   return (
// <div className="h-[100dvh] bg-black text-white flex overflow-hidden">      {/* Sidebar (desktop) */}
//       {/* <aside className="hidden lg:block w-[350px] border-r border-gray-700"> */}
//       <aside className="hidden lg:block w-[350px] border-r border-gray-700">
//         <Side />
//       </aside>
...
const DashboardLayout = () => {
  ...
  return (
    <div className="h-[100dvh] bg-black text-white flex overflow-hidden">
      ...
      {/* Mobile */}
      <div className="flex-1 lg:hidden h-full min-h-0 overflow-hidden">
        {isDetailRoute ? (
          ...
          // ensure Side can’t push the root taller
      ...
      {/* Right pane (desktop) */}
      <main className="hidden lg:block flex-1 min-h-0 overflow-hidden relative">
        <Outlet />
      </main>
    </div>
  );
