...
// // const emailExistence = require("email-existence"); // Add this at the top
...
// });
// //user info
// exports.userinfo = catchAsync(async (req, res) => {
//   const user = req.user;
...
//   const updated = await User.updateOne({ _id: userID }, { name, profilePic, preferredLanguage });

//   if (updated.modifiedCount === 0) {
//     // Gracefully handle no changes
//     return res.status(200).json({
//       success: true,
